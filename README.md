...
```markdown
git clone https://github.com/your-username/CSSART-Hacktoberfest2021.git
```

* Add upstream URL 
```markdown
git remote add upstream https://github.com/verreauxblack/CSSART-Hacktoberfest2021.git
```
